...
function addDataToTable(data) {
    for (let i = 0; i < data.length; i++) {
        ...
        let imageLink = data[i].image.link;
...
axios
    .get("https://wdmc.onrender.com/photoGallery/")
    .then((response) => {
...
addFormDom.addEventListener("submit", (e) => {
    ...
    axios
        .post("https://wdmc.onrender.com/photoGallery/", {
            image: {
                name: image,
                link: link,
            },
...
editFormDom.addEventListener("submit", (e) => {
    ...
    axios
        .patch(`https://wdmc.onrender.com/photoGallery/${id}`, {
            image: {
                name: image,
                link: link,
            },
